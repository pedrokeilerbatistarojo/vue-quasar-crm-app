<template>
  ...
  <!-- <div class="row">
    <div class="col">
      <h5>Hola, Marcos Travieso</h5>
    </div>
  </div>
  <div class="row">
    <div class="col-6">
      <h5>Tu agenda para hoy</h5>
      <div class="subcontent qcalendar-my-day">
        <div class="row justify-center">
          <div
            style="display: flex; max-width: 800px; width: 100%; height: 800px"
          >
            <q-calendar-day
              ref="calendar"
...
//           details: 'Discutir cambios para nueva campaña',
//           date: today(),
//           time: '11:00',
//           duration: 60,
//           bgcolor: 'teal-2',

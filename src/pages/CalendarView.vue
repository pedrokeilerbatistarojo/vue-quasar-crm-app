<template>
  <div class="subcontent">
    ...
    <div class="q-ma-sm q-gutter-sm row justify-center">
      <q-select
        ...
        :options="[
          ...
          { label: 'programa', value: 'scheduler' },
    ...
    <div class="row justify-center">
      <div
        style="display: flex; width: 100%; max-height: 700px"
        class="qcalendar-general"
      >
        <q-calendar
          ref="calendar"
        ...
        >
            ...
            >
              <div class="header ellipsis">
                <div class="issue ellipsis">
                  <span v-if="scope.task.icon === 'done'" class="done">
                    <Done />
                  </span>
                  <span
                ...
                <div class="logged">
                  {{ sum(scope.start, scope.end, scope.task) }}
                </div>
              </div>
            </template>
          </template>
          ...
          <!-- prettier-ignore -->
          <template v-if="selectedCalendar === 'agenda'" #day="{ scope: { timestamp } }"><!-- eslint-disable-line -->
          ...
          >
            <div class="logged-time">
              {{ getLoggedSummary(timestamp.date) }}
            </div>
          </template>
        </q-calendar>
      </div>
...
import NavigationBar from '../components/CalendarNavigationBar.vue';
...
const getAgenda = (day) => agenda[parseInt(day.weekday, 10)];
...
const blue = {
  ...
  '--calendar-scrollbar-thumb': '#C8A14D',
  ...
  '--calendar-border': '#E5E5E5 1px solid',
  ...
  '--calendar-border-current': 'black 2px solid',
  ...
  '--calendar-active-date-background': '#C8A14D',
